<aside id="sidebar" class="sidebar flex flex-col z-40">
  ...
  <!-- MENU -->
  <nav class="flex-1 py-4 overflow-y-auto flex flex-col gap-2">
    ...
    <a href="#"
       class="menu-item {{ request()->routeIs('admin.halaman.*') ? 'menu-active' : '' }}">
      <span class="menu-icon">
    ...
    <div class="mt-8 pt-4 border-t border-white/10">
      <form action="{{ route('logout') }}" method="POST">
        @csrf
        <button type="submit" class="menu-item menu-logout w-full">
          <span class="menu-icon">
