<aside id="sidebar" class="sidebar flex flex-col z-40">
  ...
  <!-- PROFILE -->
  <div class="flex flex-col items-center gap-2 py-6 border-b border-white/10 shrink-0">
    ...
    <div class="sidebar-text text-sm font-semibold">Guru X</div>
    <div class="sidebar-text text-xs text-white/60">Staff/Guru</div>
  </div>

  <!-- MENU -->
  <nav class="flex-1 py-4 overflow-y-auto flex flex-col gap-1">
