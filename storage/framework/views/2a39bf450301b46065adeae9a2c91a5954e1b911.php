<aside id="sidebar" class="sidebar flex flex-col z-40">
  ...
  <div class="flex flex-col items-center py-6 border-b border-white/10 shrink-0">
    ...
    <img src="<?php echo e(asset('images/logosekolah.png')); ?>" class="w-12 h-12 rounded-full mb-3">
  ...
  <nav class="flex-1 py-3 overflow-y-auto flex flex-col gap-1">
    ...
    <button type="button" onclick="window.location.href='<?php echo e(route('admin.dashboard')); ?>'"
            class="menu-item text-left <?php echo e(request()->routeIs('admin.dashboard') ? 'menu-active' : ''); ?>">
    ...
    <button type="button" onclick="window.location.href='<?php echo e(route('admin.siswa')); ?>'"
            class="menu-item text-left <?php echo e(request()->routeIs('admin.siswa*') ? 'menu-active' : ''); ?>">
      <span class="menu-icon"><i class="fa-solid fa-user-graduate"></i></span>
      <span class="sidebar-text">Data Siswa</span>
    </button>

    <button type="button" onclick="window.location.href='<?php echo e(route('admin.guru')); ?>'"
            class="menu-item text-left <?php echo e(request()->routeIs('admin.guru*') ? 'menu-active' : ''); ?>">
      <span class="menu-icon"><i class="fa-solid fa-chalkboard-user"></i></span>
      <span class="sidebar-text">Data Guru</span>
    </button>

    <button type="button" onclick="window.location.href='<?php echo e(route('admin.kelas')); ?>'"
            class="menu-item text-left <?php echo e(request()->routeIs('admin.kelas*') ? 'menu-active' : ''); ?>">
      <span class="menu-icon"><i class="fa-solid fa-door-open"></i></span>
      <span class="sidebar-text">Data Kelas</span>
    </button>

    <button type="button" onclick="window.location.href='<?php echo e(route('admin.mapel')); ?>'"
            class="menu-item text-left <?php echo e(request()->routeIs('admin.mapel*') ? 'menu-active' : ''); ?>">
    ...
    <button type="button" onclick="window.location.href='<?php echo e(route('admin.pembagian-kelas')); ?>'"
            class="menu-item text-left <?php echo e(request()->routeIs('admin.pembagian-kelas*') ? 'menu-active' : ''); ?>">
      <span class="menu-icon"><i class="fa-solid fa-users-rectangle"></i></span>
      <span class="sidebar-text">Pembagian Kelas</span>
    </button>

    <button type="button" onclick="window.location.href='<?php echo e(route('admin.jadwal')); ?>'"
            class="menu-item text-left <?php echo e(request()->routeIs('admin.jadwal*') ? 'menu-active' : ''); ?>">
    ...
    <button type="button" onclick="window.location.href='<?php echo e(route('admin.kelola-halaman')); ?>'"
            class="menu-item text-left <?php echo e(request()->routeIs('admin.kelola-halaman*') ? 'menu-active' : ''); ?>">
    ...
    <button type="button" onclick="window.location.href='<?php echo e(route('home')); ?>'"
            class="menu-item text-left <?php echo e(request()->routeIs('admin.landing*') ? 'menu-active' : ''); ?>">
...
</aside><?php /**PATH D:\Capstone\capstone-simak\resources\views/layouts/sidebar-admin.blade.php ENDPATH**/ ?>